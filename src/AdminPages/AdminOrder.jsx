              ...
              <table className="w-full text-sm text-left rtl:text-right text-gray-100 dark:text-gray-400">
                ...
                <tbody className="bg-[#343434]">
                  <tr className="bg-[#343434]  dark:bg-gray-800 dark:border-gray-700  dark:hover:bg-gray-600">
                    ...
                    <th
                      scope="row"
                      className="flex items-center px-6 py-4 text-[#FFFFE8] whitespace-nowrap dark:text-white"
                    >
                      <div className="ps-3">
                        <div className="text-base font-semibold">$52.36</div>
                      </div>
                    </th>
                    ...
                    <td className="px-6 py-4 flex gap-6">
                      <div className="flex gap-1">
                        ...
                        <span className="text-[#9092B7]">Options</span>
                      </div>
                      <div className="flex gap-1">
                        <img
                          className="w-5 h-5"
                          src="src\images\Subtract.png"
                        />
                        <span className="text-[#9092B7]">Resend invoice</span>
                      </div>
                    </td>
                  </tr>
                  {/* 2 */}
