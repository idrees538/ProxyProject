  ...
  return (
    <section className=" w-full h-full  bg-[linear-gradient(135deg,_rgba(87,120,117,1)_3%,_rgba(74,82,89,1)_30%,_rgba(74,82,89,1)_69%,_rgba(83,107,108,1)_98%)] pb-7">
      ...
      <div className="flex col-span-2 ...">
        ...
        {/* 1 */}
        <section className="md:p-0 ml-10 md:ml-[2rem] lg:ml-[10rem] md:mt-[3rem]">
          {/* Create Product */}
          <div className=" md:p-1 ">
            ...
            <h1 className="  text-white font-bold text-lg ">Create Product</h1>
...
export default AdminProductNext;
