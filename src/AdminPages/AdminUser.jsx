      ...
      <div className="flex col-span-2 ...">
        ...
        <section className=" relative overflow-x-scroll hide-scroll-bar p-4 md:p-0  md:ml-[1rem] lg:ml-[10rem] mt-[5rem]">
          ...
          <div className=" ">
            ...
            <div className=" flex flex-row justify-between md:gap-[78px] lg:gap-[180px] p-4 pl-6 pr-6 mt-[1rem] w-full h-[5rem] rounded-2xl bg-[#000300]">
              <div className=" flex justify-between gap-9 md:gap-[78px] lg:gap-[180px]">
                ...
                <div className="  flex gap-3 bg-transparent w-[200px]"></div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-[1rem] ">
            <h1 className=" text-white font-bold text-lg ">All Users</h1>
            {/* <div className="overflow-y-scroll hide-scroll-bar flex gap-20 px-3 mt-[1rem] w-full h-[700px] rounded-2xl p-3 bg-[#000300]"> */}

            {/* table */}
            <div className="overflow-y-scroll overflow-x-scroll hide-scroll-bar shadow-md sm:rounded-lg h-[700px]">
              <div className=" flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0  bg-[#343434] dark:bg-gray-900"></div>
              <table className="w-full text-sm text-left rtl:text-right text-gray-100 dark:text-gray-400">
                  ...
                  <tr>
                    ...
                    <th scope="col" className="px-6 py-3">
                      <button
                        ...
                        className="inline-flex items-center text-[#EFF0F6] bg-[#343434] border border-gray-300 focus:outline-none  focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
                        type="button"
                      >
                    ...
                    <th scope="col" className="px-2 py-3">
                      <div className="relative ">
                        ...
                        <input
                          ...
                          className="block p-2 ps-10 text-sm text-[#FFFFE8]  rounded-lg w-60 bg-[#343434] focus:ring-blue-500 focus:lue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:lue-500"
                          placeholder="Search "
                        />
                      </div>
                    </th>
                ...
                <tbody className="bg-[#343434]">
                  <tr className="bg-[#343434]  dark:bg-gray-800 dark:border-gray-700  dark:hover:bg-gray-600">
                    <td className="w-4 p-4">
                      <div className="flex items-center">
                        <input
                          ...
                          type="checkbox"
                          className="w-4 h-4 rounded-xl text-gray-800 bg-gray-100 border-gray-300  focus:ring-blue-100 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                        />
                      </div>
                    </td>
                    <th
                      scope="row"
                      className="flex items-center px-6 py-4 text-white whitespace-nowrap dark:text-white"
                    >
                      <div className="ps-3">
                    ...
                    <td className="px-6 py-4 text-[#00B795]">Admin</td>
                    <td className="px-6 py-4">
                      <div className="flex items-center">29 August 2023</div>
                    </td>
                    <td className="px-6 py-4">29 November 2023</td>
                    <td className="px-6 py-4 flex gap-9">
                      <img src="src\images\Menu.png" />
                      <img src="src\images\Chield_check_fill.png" />
                      <img src="src\images\Remove_fill.png" />
                      <img src="src\images\Close_round_fill.png" />
                    </td>
                  </tr>
                  ...
                  <tr className="bg-[#343434]  dark:bg-gray-800 dark:border-gray-700  dark:hover:bg-gray-600">
                    ...
                    <td className="px-6 py-4 font-bold text-[#FFFFE8]">User</td>
                    <td className="px-6 py-4">
                      <div className="flex items-center">29 August 2023</div>
                    </td>
                    <td className="px-6 py-4">29 November 2023</td>
                  ...
                  <tr className="bg-[#343434]  dark:bg-gray-800 dark:border-gray-700  dark:hover:bg-gray-600">
                    ...
                    <td className=" font-bold px-6 py-4 text-[#FF8686]">
                      Banned
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center">29 August 2023</div>
