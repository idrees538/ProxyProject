...
function Dashboard() {
  ...
  return (
    <section className="min-h-screen bg-[linear-gradient(135deg,_rgba(87,120,117,1)_3%,_rgba(74,82,89,1)_30%,_rgba(74,82,89,1)_69%,_rgba(83,107,108,1)_98%)] pb-7">
      {/* navbar */}
      ...
      <div className="flex col-span-2 ...">
        ...
        <section className="  md:ml-[1rem] lg:ml-[8rem] mt-[1rem]">
          ...
          <div className=" md:m-[1rem] mt-[3rem] pb-[2rem] p-3 md:p-0 md:pr-4">
            <div>
              <h1 className=" text-white font-bold text-xl">
                Recent Transaction
              </h1>
            </div>
            <div className=" relative overflow-y-scroll hide-scroll-bar flex flex-col gap-3 w-full h-[11rem] bg-black rounded-lg  p-4 mt-4 ">
              {/* 1 */}
