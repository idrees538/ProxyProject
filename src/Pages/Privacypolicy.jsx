    ...
    <div>
      <div className=" bg-[linear-gradient(135deg,_rgba(87,120,117,1)_3%,_rgba(74,82,89,1)_30%,_rgba(74,82,89,1)_69%,_rgba(83,107,108,1)_98%)]">
        ...
        <div className=" md:ml-1 lg:ml-20 mt-10 lg:mt-40 p-5">
          <h1 className=" text-white text-3xl lg:text-5xl font-bold w-[20rem]">
          Privacy Policy
          </h1>
          ...
          <div className=" mt-4 text-center mr-[78rem]">
              <button className=" bg-[#FF8686] text-black text-sm rounded-md w-[10rem] md:w-[15rem] px-2 py-2">
              My Cookie Preferences
              </button>
            </div>

            <div className=" bg-[#343434] shadow-md shadow-[#000300] lg:mr-24 w-[100%] h-[30rem]  mt-4 rounded-md p-5 overflow-y-scroll">          
