...
import SupportMyToken from "../Components/SupportMyToken";
function Support() {
  const [isOpens, setIsOpen] = React.useState(false);
  return (
    <div className=" w-full h-full  bg-[linear-gradient(135deg,_rgba(87,120,117,1)_3%,_rgba(74,82,89,1)_30%,_rgba(74,82,89,1)_69%,_rgba(83,107,108,1)_98%)]">
      {/* navbar */}
...
<div className=" flex">
  <div className=" flex gap-5 px-10 py-5 hover:bg-gray-400 w-[15rem] rounded-r-md">
    ...
    <h1 className=" text-white font-bold text-xl cursor-pointer">Support</h1>
        ...
        {/* 1 */}
        <div className="  md:ml-[3rem] lg:ml-[8rem] mt-[4rem]">
        <div className="mt-[1rem] ">
            ...
            <div className=" mt-[3rem] p-3 pb-[2rem] lg:ml-0">
            <div>
              <h1 className=" text-white font-bold text-xl m-[0.5rem] md:m-0">
                Ticket History
              </h1>
            </div>
            <div className=" relative overflow-y-scroll hide-scroll-bar flex flex-col gap-3 w-full h-[20rem] bg-black rounded-xl ml-[1px] md:ml-[-1.5rem] lg:ml-0  p-4 mt-4 ">
              {/* 1 */}
